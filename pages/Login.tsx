    ...
    <div className="relative flex h-full min-h-screen w-full flex-col items-center justify-center p-6 bg-background-light dark:bg-background-dark overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[360px] flex flex-col gap-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="h-12 flex items-center justify-center bg-white dark:bg-[#1A1A1A] border border-stone-200 dark:border-white/10 hover:border-primary dark:hover:border-primary rounded-sm transition-all duration-300 group shadow-sm">
             {/* Google SVG Oficial */}
          ...
          <button className="h-12 flex items-center justify-center bg-white dark:bg-[#1A1A1A] border border-stone-200 dark:border-white/10 hover:border-primary dark:hover:border-primary rounded-sm transition-all duration-300 group shadow-sm text-stone-900 dark:text-white">
             {/* Apple SVG Oficial */}
